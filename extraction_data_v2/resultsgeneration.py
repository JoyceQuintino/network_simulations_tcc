...
def create_graphic_interval_confidence(med, name_model, name_inter, min, max, vali, predi1, pred1, set_test,
    ...
    plt.savefig(name_model+'3.png')

def create_graphic_interval_confidence2(med, name_model, name_inter, tam_pac, min, max, vali, predi1, pred1, set_test):
    ...
    plt.xlabel('Principal componente', fontsize=26)
    plt.ylabel(med, fontsize=26)
    plt.savefig(name_model+'_'+tam_pac+'_3.png')