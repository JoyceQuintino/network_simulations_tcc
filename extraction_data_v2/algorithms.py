...
def mlp():
    ...
    rg.create_graphic_interval_confidence2('Taxa de entrega %', 'mlp', a, c, min, max, vali, predi1, pred1, set_test)
    ...
    rg.create_graphic_interval_confidence2('Taxa de entrega %', 'mlp', a, c2, min2, max2, vali2, predi2, pred2, set_test2)
    ...
    rg.create_graphic_interval_confidence2('Taxa de entrega %', 'mlp', a, c3, min3, max3, vali3, predi3, pred3, set_test3)

    rg.create_graphic_interval_confidence('Taxa de entrega %', 'mlp', a, min, max, vali, predi1, pred1, set_test,
...
def dt():
    ...
    score, error, dt = ml.experiment_folds2('dt', dt, x, y)
    ...
    score2, error2, dt2 = ml.experiment_folds2('dt', dt2, x2, y2)
    ...
    score3, error3, dt3 = ml.experiment_folds2('dt', dt3, x3, y3)
    ...
    rg.create_graphic_interval_confidence('Taxa de entrega', 'dt', min, max, vali, predi1, pred1, set_test,
                                                                    min2, max2, vali2, predi2, pred2, set_test2,
                                                                    min3, max3, vali3, predi3, pred3, set_test3)
...
def rf():
    ...
    score, error, rf = ml.experiment_folds2('rf', rf, x, y)
    ...
    score2, error2, rf2 = ml.experiment_folds2('rf', rf2, x2, y2)
    ...
    score3, error3, rf3 = ml.experiment_folds2('rf', rf3, x3, y3)
    ...
    rg.create_graphic_interval_confidence('Taxa de entrega', 'rf', min, max, vali, predi1, pred1, set_test,
                                                                    min2, max2, vali2, predi2, pred2, set_test2,
                                                                    min3, max3, vali3, predi3, pred3, set_test3)
...
def svr():
    ...
    rg.create_graphic_interval_confidence('Taxa de entrega', 'svr', min, max, vali, predi1, pred1, set_test,
                                                                    min2, max2, vali2, predi2, pred2, set_test2,
                                                                    min3, max3, vali3, predi3, pred3, set_test3)